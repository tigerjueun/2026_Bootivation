...
| 팀원 | 주요 담당 | 핵심 결과물 |
|---|---|---|
| **박주은** [@tigerjueun](https://github.com/tigerjueun) | 전체 시스템 아키텍처, Fusion PC, 통신 통합, RPi 트레이·음성, Rider 펌웨어 보정, GitHub 아카이빙 | 상태머신, POS/Rider/RPi/Vision 연동, ZMQ·Serial, 운영 문서 |
| **혜은** | ATmega128 POS | 기존 ASM 분석, C 모듈화, 센서·LCD·FND·결제 UI, 실물 회로 |
